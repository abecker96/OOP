...
/**
 * <h1>UI</h1> UI handling class, sets parameters and related data for
 * formatting of UI elements using Swing and JFrame libs
 *
...
public class UI {
	...
	public Font titleFont = new Font("Arial", Font.PLAIN, 90);
	public Font normalFont = new Font("Arial", Font.PLAIN, 20);
	...
	/**
	* This method is create the GUI when the game first launches.
	* @param cHandler This is the ActionListener that we are using to change positions in the story
	* @return none
	*/
